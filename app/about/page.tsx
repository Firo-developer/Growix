  ...
  return (
    <main className="public-header-offset min-h-screen bg-bg px-4 pb-14 text-heading sm:px-6 lg:px-8">
      ...
      <section className="mx-auto max-w-5xl pt-8 sm:pt-14">
        <p className="public-accent text-sm font-medium">About Growix</p>
        ...
        <p className="mt-6 max-w-2xl text-[17px] leading-7 text-text">Growix brings business planning, marketing direction, and AI-supported guidance into one practical workspace. It is built to help owners move from uncertainty to useful action.</p>
